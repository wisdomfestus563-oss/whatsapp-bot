...
http.createServer(function(req, res) {
  if (req.url === '/qr') {
    ...
    if (lastQR) {
      res.end('<html><body><h2>Scan this QR code with WhatsApp</h2><img src="https://api.qrserver.com/v1/create-qr-code/?size=300x300&data=' + encodeURIComponent(lastQR) + '"/></body></html>');
    } else {
      res.end('<html><body><h2>No QR code yet. Bot may already be connected!</h2></body></html>');
    }
  } else {
    res.writeHead(200);
